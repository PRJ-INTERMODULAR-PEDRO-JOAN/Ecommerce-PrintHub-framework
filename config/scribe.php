...
return [
    ...
    'auth' => [
        ...
        'default' => false,
        'in' => 'bearer',       // <-- Asegúrate de que pone 'bearer'
        'name' => 'Authorization',
        'use_value' => env('SCRIBE_AUTH_KEY'),
        'placeholder' => '{AQUÍ_PONDRÁS_TU_TOKEN}',
        'extra_info' => 'Puedes generar un token iniciando sesión y pegarlo aquí para probar los endpoints protegidos.',
    ],
